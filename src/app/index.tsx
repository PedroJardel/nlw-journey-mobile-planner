...
export default function Index() {
    ...
    return (
        <View className='flex-1 items-center justify-center px-5'>
            ...
            <Text className='color-zinc-400 font-regular text-center text-lg mt-3'>
                Convide seus amigos e planeje sua {"\n"} próxima viagem
            </Text>
            <View className='w-full bg-zinc-800 p-4 rounded-lg  my-8 border border-zinc-700'>
                <Input>
                    <MapPin color={colors.zinc[400]} size={20} />
                    <Input.Field placeholder='Pra onde?' editable={stepForm === StepForm.TRIP_DETAILS}/>
                </Input>
                    ...
                    <>
                        <View className='border-b py-3 border-zinc-700'>
                            <Button variant='secondary' onPress={() => setStepForm(StepForm.TRIP_DETAILS)}>
                                <Button.Title>Alternar local/data</Button.Title>
                ...
                <Button onPress={handleNextStepFrom}>
                    <Button.Title>{
